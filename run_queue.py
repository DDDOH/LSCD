from _queue_1.lib import const_multi_server_queue
from _queue_1.lib import changing_multi_server_queue
from _queue_1.lib import single_server_queue
from _queue_1 import ffi
...
single_server_queue(arrival_time_ls_c, service_time_ls_c, wait_time_ls_c, n_customer)
